...
if __name__=='__main__':
    ...
    # featureページを生成
    with open(TEMPLATE_BASE_PATH + 'feature_template.txt', mode='r', encoding='utf-8') as f:
    ...
    api_write_content = api_template.substitute(description=description, api=api_sorted_text, page_url=api_url)
    ...
    # aws service index作成
    with open(TEMPLATE_BASE_PATH + 'service_index.txt', mode='r', encoding='utf-8') as f:
